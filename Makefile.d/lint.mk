...
audit-recent-prs-test:  ## Fixture-driven test for audit-recent-prs.sh (malformed token, phantom dep cite, missing token modes). Gate itself runs daily in subagent-quality-audit workflow (closes #1033).
	bash scripts/audit-recent-prs_test.sh
