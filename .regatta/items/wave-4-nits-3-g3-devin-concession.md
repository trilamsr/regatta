...
Source: unified next-horizon roadmap §7.3 Devin row already carries the concession verbatim: "Devin 3.0 re-planning loop — adopt-pattern for autonomous-session-prompt evolution; competitor product otherwise. **Concession in §10:** regatta's loop is 'more constrained' than 'more sophisticated.'"
