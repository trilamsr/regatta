// Package githubissues implements schemas.WorkItemSource over GitHub Issues labelled `autonomous` (MVR-1-T4); deterministic projection, LLM inference forbidden (spec §6.2).
