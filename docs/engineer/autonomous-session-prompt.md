...
PRIORITY (top-down, skip if blocked) — driven by docs/engineer/briefs/2026-06-01-self-host-first.md §3 + (when merged) docs/engineer/briefs/2026-06-02-next-horizon-roadmap.md (#433) + docs/engineer/specs/2026-06-02-observability-roadmap.md (#432)
...
PHASE MVR-1 — Next-horizon customer wedges. Unified brief at `docs/engineer/briefs/2026-06-02-next-horizon-roadmap.md` (#433 OPEN; merge gates whole phase). 4 impl-ready items: MVR-1-T1 (W7 wave-1 htmx UI), MVR-1-T2 (regatta init bundle), MVR-1-T5 (P3.8 SCM adapter — Gitea/GitLab), MVR-1-T6 (priced-support contract template). All gated `mvr-1-entry`: 30-day-self-host-green OR named persona-A inbound. **DO NOT dispatch MVR-1 implementers until gate fires.** Triage 4 RISK followups #423 #424 #426 #427 in parallel (persona qualify · sales-channel · precedent counter-evidence · pricing-unit pin).
...
- **2026-06-02 Strategic-design CONVERGENCE**: #432 MERGED observability-roadmap converged spec (consolidates #400 #405 #410 #413 #420). #433 OPEN next-horizon roadmap unified brief — 4 MVR-1 impl-ready items + 16 wave-4 items + 4 RISK followups (#423 #424 #426 #427). 29 prior strategic-design PRs CLOSED as superseded per `feedback_design_iteration_local`. Boot-prompt refresh PR #437 still OPEN (BLOCKED) — superseded by this refresh on post-PM-wave content.
